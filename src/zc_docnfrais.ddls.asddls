@EndUserText.label: 'Projection View for Doc Note Frais (Form)'
...
define view entity ZC_docnfrais as projection on ZI_docnfrais
{
...
//      comments,
      ...
      _notefrais : redirected to parent ZC_NoteFrais
}
