@EndUserText.label: 'Projection View for Doc Note Frais (Consulter)' 
...
define view entity ZC_docnfrais_consulter as projection on ZI_docnfrais_consulter
{
...
//      comments,
      ...
      _notefrais : redirected to parent ZC_LT_NOTEFRAIS_CONSULTER
}
