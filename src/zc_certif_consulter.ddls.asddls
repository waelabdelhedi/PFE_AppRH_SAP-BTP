@EndUserText.label: 'Projection View for Certif (Consulter)'
...
define root view entity ZC_CERTIF_CONSULTER
  provider contract transactional_query as projection on ZI_CERTIF_CONSULTER
{
